import psycopg, json
url = 'postgresql://neondb_owner:***ROTATED-SECRET***@ep-lively-lake-agvifdsa.c-2.eu-central-1.aws.neon.tech/neondb?sslmode=require'
try:
        ...
        with conn.cursor() as cur:
            ...
            cur.execute("""
                INSERT INTO sp_ingestion_log
                  (source, status, records, error, payload, created_at, updated_at)
