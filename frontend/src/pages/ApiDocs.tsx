...
const ENDPOINTS = [
  {
    ...
    "desc": "Health check.",
    "body": null,
    "response": "{\"status\":\"ok\",\"service\":\"streampulse\"}"
  },
  {
    "method": "POST",
    "path": "/ingest",
    "desc": "Ingest a single event or batch.",
    "body": "{\n  \"source\": \"crm\",\n  \"event_type\": \"deal_closed\",\n  \"payload\": {\"deal_id\": \"D-001\", \"amount\": 15000}\n}",
    "response": "{\"event_id\":\"evt_abc\",\"status\":\"ingested\",\"classified_as\":\"revenue\"}"
  },
  {
    "method": "POST",
    "path": "/classify",
    "desc": "AI-classify an event without persisting.",
    "body": "{\"text\":\"Server CPU reached 98% \u2014 possible memory leak\"}",
    "response": "{\"category\":\"infrastructure_alert\",\"confidence\":0.97,\"severity\":\"high\"}"
  },
  {
    "method": "GET",
    "path": "/events",
    "desc": "List recent events with filters.",
    "body": null,
    "response": "[{\"id\":\"evt_abc\",\"source\":\"crm\",\"event_type\":\"deal_closed\",\"ts\":\"2026-07-16T07:00:00Z\"}]"
  },
  {
    "method": "POST",
    "path": "/webhook/register",
    "desc": "Register a destination webhook for routed events.",
    "body": "{\"url\":\"https://your.app/webhook\",\"events\":[\"revenue\",\"alert\"],\"secret\":\"webhook-secret\"}",
    "response": "{\"destination_id\":\"dst_xyz\",\"status\":\"active\"}"
  }
];
    ...
    <div style={{ padding:"24px 32px",maxWidth:1100,color:"#e2e8f0" }}>
      <div style={{ display:"flex",alignItems:"center",gap:12,marginBottom:8 }}>
        ...
        <div>
          ...
          <p style={{ margin:0,fontSize:"0.85rem",color:"#94a3b8" }}>{"Ingest, classify and route real-time events from any source"}</p>
        </div>
      </div>
